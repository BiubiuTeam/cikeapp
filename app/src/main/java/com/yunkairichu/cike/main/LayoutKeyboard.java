...
/**
 * Created by vida2009 on 2015/6/13.
 */
public class LayoutKeyboard extends RelativeLayout {
    public LayoutKeyboard(final Context context, final AttributeSet attrs) {
        super(context, attrs);
    }
