...
import com.yunkairichu.cike.adapter.FaceAdapter;
import com.yunkairichu.cike.adapter.ViewPagerAdapter;
...
public class FaceRelativeLayout extends RelativeLayout implements
        ...
        if (view.getVisibility() != View.VISIBLE) {
            ...
            TranslateAnimation translateAnimation =
                    new TranslateAnimation(
                            ...
                            Animation.ABSOLUTE,0f,
                            Animation.ABSOLUTE,view.getHeight(),
    ...
    private void Init_Point() {
        ...
        for (int i = 0; i < pageViews.size(); i++) {
            ...
            if (i == 1) {
                imageView.setBackgroundResource(R.drawable.shen_point);
            }
            ...
            public void onPageSelected(int arg0) {
                ...
                if (arg0 == pointViews.size() - 1 || arg0 == 0) {
                    if (arg0 == 0) {
                        ...
                        pointViews.get(1).setBackgroundResource(R.drawable.shen_point);
                    } else {
                        vp_face.setCurrentItem(arg0 - 1);// 倒数第二屏
                        pointViews.get(arg0 - 1).setBackgroundResource(
                                R.drawable.shen_point);
                    }
                }
            }
    ...
    public void draw_Point(int index) {
        for (int i = 1; i < pointViews.size(); i++) {
            if (index == i) {
                pointViews.get(i).setBackgroundResource(R.drawable.shen_point);
            } else {
                pointViews.get(i).setBackgroundResource(R.drawable.qian_point);
            }
        }
    }
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        ImageView iv_face = (ImageView)arg1.findViewById(R.id.gridImage);
        iv_face.startAnimation(scaleAnimation);

        ChatEmoji emoji = (ChatEmoji) faceAdapters.get(current).getItem(arg2);
        ActivityChat chatActivity = (ActivityChat)context;
        chatActivity.didClickToSendEmoji(emoji);
    }
}
