...
//                        R.layout.row_sent_message, null);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if (message.getType() == EMMessage.Type.IMAGE) {
                try {
                    holder.iv = ((ImageView) convertView.findViewById(R.id.sendPicture));    //传图片
                    holder.iv_avatar = (ImageView) convertView.findViewById(R.id.userhead); //头像，下同
                    //holder.tv = (TextView) convertView.findViewById(R.id.percentage);  //百分比先不弄，下同
                    //holder.pb = (ProgressBar) convertView.findViewById(R.id.progressBar); //进度条也不弄，下同
                    holder.pb = (ProgressBar) convertView.findViewById(R.id.sending); //进度条转圈圈，下同
                    holder.staus_iv = (ImageView) convertView.findViewById(R.id.msg_status); //重传，下同
                    //holder.tv_usernick = (TextView) convertView.findViewById(R.id.tv_userid); //昵称不要，下同
                } catch (Exception e) {
                }
...
//                    holder.tv = (TextView) convertView.findViewById(R.id.tv_chatcontent);
                ...
                try {
                    holder.iv = ((ImageView) convertView.findViewById(R.id.voice));
                    holder.iv_avatar = (ImageView) convertView.findViewById(R.id.userhead);
...
//                activity.startActivityForResult(
//                        (new Intent(activity, ContextMenu.class)).putExtra("position", position).putExtra("type",
//                                EMMessage.Type.IMAGE.ordinal()), ActivityChat.REQUEST_CODE_CONTEXT_MENU);
//                return true;
//            }
//        });
//
